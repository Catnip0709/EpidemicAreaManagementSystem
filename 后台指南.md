...
+ 参数  {"userID":"45222319907090049","userName":"张三","password":"123456","phone":"13347729889","buildingID":"20","familyID":"22", "state":"健康"}  
...
int buildingID          居住栋号  
int familyID            居住户号  
string state            当前健康状况（"健康"、"隔离"、"疑似"、"确诊"、"死亡"）
+ 返回值   {"result":0}  
（1）result取值  
SUCCESS 0               成功  
...
## 13、用户查看隔离状态 QuarantineInformation
