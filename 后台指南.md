...
+ 测试命令  
curl localhost:80/login -X POST -H "Content-Type:application/json" -d '"userID":"452223199907095222","password":"1234567","isAdmin":"1"'  
...
## 23、根据用户名、栋、户、手机号查找用户信息 viewUserInfo
